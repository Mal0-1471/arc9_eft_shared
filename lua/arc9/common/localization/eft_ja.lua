...
-- [[ HUD ]]
L["eft_hud_full"] = "フル装填"
L["eft_hud_empty"] = "残弾なし"
L["eft_hud_nearlyfull"] = "残弾多数"
L["eft_hud_aboutfull"] = "約半分"
L["eft_hud_lessthanhlaf"] = "半分未満"
L["eft_hud_almostempty"] = "残りわずか"
L["eft_hud_none"] = "なし"
L["eft_hud_malf"] = "動作不良: \"%s\""
L["eft_hud_misfire"] = "不発"
L["eft_hud_eject"] = "排莢不良"
L["eft_hud_feed"] = "装填不良"
L["eft_hud_bolt"] = "ボルトスタック"
L["eft_hud_missing"] = "武器に必須パーツがありません."
L["eft_hud_badtrip"] = "トリップワイヤーを設置できません"

-- [[ Weapon Categories ]]
L["eft_subcat_carb"] = "5アサルトカービン"
L["eft_subcat_ar"] = "1アサルトライフル"
L["eft_subcat_sg"] = "6ショットガン"
L["eft_subcat_snip"] = "4スナイパーライフル & マークスマンライフル"
L["eft_subcat_smg"] = "2サブマシンガン"
L["eft_subcat_lmg"] = "3軽機関銃"
L["eft_subcat_pist"] = "7ピストル"
L["eft_subcat_melee"] = "9近接武器"
L["eft_subcat_grenades"] = "8グレネード & グレネードランチャー"
...
L["eft_class_weapon_toy"] = "トイガン"
L["eft_class_weapon_signalpis"] = "Signal pistol"
L["eft_class_weapon_dbsg"] = "ダブルバレルショットガン"
...
L["eft_class_weapon_special"] = "特殊アイテム"
...
L["eft_fmode_grenade"] = "グレネード"
L["eft_fmode_pump"] = "Pump"
L["eft_fmode_throw"] = "投擲武器"
L["eft_fmode_tripwire"] = "Tripwire"
L["eft_fmode_singleshot"] = "単発"
L["eft_fmode_doubletap"] = "ダブルタップ"
...
L["eft_cat_ammo"] = "弾薬" -- Should never be seen, but better safe than sorry
L["eft_cat_misc"] = "その他"
...
L["eft_cat_tactical_u"] = "タクティカル" .. attdir.u
L["eft_cat_tactical_b"] = "タクティカル" .. attdir.b

L["eft_cat_mount_l"] = "マウント" .. attdir.l
...
-- [[ TOZ-106 + MP-18 ]]
-- ammo_20x70
L["eft_ammo_20x70_elephant.printname"] = "20/70 \"Elephant Killer\" スラグ"
...
L["eft_ammo_20x70_explosive.printname"] = "20/70 \"X-PLSV\" スラグ"
...
L["eft_optic_okp7_sigma.printname"] = "OKP-7 リフレックスサイト (Dovetail reticle)"
L["eft_optic_okp7_sigma.compactname"] = "OKP-7"
L["eft_optic_okp7_sigma.description"] = "Uses the reticle from the dovetail variant.\nOKPサイトの独特なデザインは不安定な姿勢での即応射撃を可能にし、オペレーターにかかる疲労を軽減する。また必要であればサイトを付けたままでもアイアンサイトが使用できる。射界を妨げないリムレスのリフレクターが特徴で、これを保護するバイザーも射撃の妨げとならないように薄く頑丈に作られている。" .. extrasatt
...
-- [[ extras_ammo ]]
L["eft_ammo_12x70_explosive.printname"] = "12/70 \"X-PLSV\" スラグ"
...
L["eft_rec_g17_std_stick.description"] = "Glock 9x19ピストル用の標準スライド。" .. extrasatt .. stickersatt
...
L["eft_ks23_stock_wood_sticker.description"] = "ゴム製バットプレートの付いたKS-23ショットガン用の木製ストック" .. extrasatt .. stickersatt
...
-- [[ SKS + SVT + AVT ]]
-- [[ sks ]]
L["eft_sks_op.printname"] = "OP-SKS 7.62x39 カービン (狩猟ライフルバージョン)"
L["eft_sks_op.compactname"] = "OP-SKS"
L["eft_sks_op.description"] = "OP-SKS カービンは、最も一般的な弾薬である 7.62x39mm 弾を装填するように設計されている。重量や寸法は、様々な年齢や身長の使用者が使いやすいカービンとなっていて、50年以上にわたり、いろんな種類の伝統的なロシアの狩猟に使用されてきた。ロシアだけでなく、アフリカ、東南アジア、中央アメリカ、中東などで肉食動物に対するテストも行われている。" .. convatt
...
L["eft_kedr_conv_b.printname"] = "PP-91-01 \"Kedr-B\" 9x18PM サブマシンガン"
L["eft_kedr_conv_b.compactname"] = "PP-91-01 Kedr-B"
L["eft_kedr_conv_b.description"] = "PP-91 ”ケダール” サブマシンガンの珍しい消音型で、PP-91-01 \"ケダール-B\" と呼ばれている。" .. convatt

L["eft_kedr_conv_klin.printname"] = "PP-9 \"クリン\" 9x18PMM サブマシンガン"
L["eft_kedr_conv_klin.compactname"] = "PP-9 Klin"
L["eft_kedr_conv_klin.description"] = "PP-9 “クリン” は、”ケダール” サブマシンガンの進化型で、発射速度が高く、その薬室は 9x18 PMM 弾薬が使用できるように設計されている。1996年から2002年にかけて総務省の命令によって製造されている。" .. convatt
...
L["eft_slide_1911_m45_blk.printname"] = "M45A1 .45 ACP スライド (Black)"
