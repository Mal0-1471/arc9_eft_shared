...
L["eft_weapon_t5000m_full"] = "ORSIS T-5000M 7.62x51 ボルトアクション スナイパーライフル"
L["eft_weapon_t5000m_desc"] = "ORSIS T-5000M はロシアのボルトアクションスナイパーライフルだ。ORSIS が開発した最初の製品で、モスクワの工場で生産されている。2011年にロシアのニジニ・タギルで行われたロシア兵器展示会で発表され、他社の部品を一切使用していない完全なオリジナルだ。優れた使用感、素早い照準からの射撃、高い信頼性、エルゴノミクスも特徴だ。また、ステンレス鋼製の銃身には、マズルブレーキ・コンペンセーターやサプレッサーを取り付けるためのネジがついている。マズルブレーキ等を装備することによって、反動による衝撃を効率的に減少させ、反動制御がしやすくなる。"
...
L["eft_weapon_mp5kn_full"] = "MP5K 9x19 サブマシンガン"
L["eft_weapon_mp5kn_desc"] = "HK MP5K（Kはドイツ語の\"Kurz\"から来ており、\"短い\"を意味する）は、MP5 サブマシンガンの短縮版で、秘密作戦や特殊部隊による近接戦闘での使用を目的として設計されたものだ。"
...
L["eft_weapon_pp9_full"] = "PP-9 \"クリン\" 9x18PMM サブマシンガン"
L["eft_weapon_pp9_desc"] = "PP-9 “クリン” は、”ケダール” サブマシンガンの進化型で、発射速度が高く、その薬室は 9x18 PMM 弾薬が使用できるように設計されている。1996年から2002年にかけて総務省の命令によって製造されている。"
...
L["eft_weapon_pp91_full"] = "PP-91 Kedr 9x18PM サブマシンガン"
L["eft_weapon_pp91_desc"] = "PP-91 \"ケダール\" は、9x18mm PM口径のサブマシンガンで、エフゲニー・ドラグノフによって内務省の命令で1990年代初頭に設計され、ZMZ（Zlatoústovskiy Mashinostroítelnyy Zavód - \"ズラトゥースト機械製造工場\"）で生産されている。シンプルで効率的な設計がされていて、軽量だからパフォーマンスに影響を与えずに快適に運ぶことができるだけなく、反動に影響を与えないで高い発射速度を備えている。これらの特性から、ほとんどのロシアの法執行機関で現在も制式武器として使用されている。"

L["eft_weapon_pp9101"] = "PP-91-01 Kedr-B"
L["eft_weapon_pp9101_full"] = "PP-91-01 \"Kedr-B\" 9x18PM サブマシンガン"
L["eft_weapon_pp9101_desc"] = "PP-91 ”ケダール” サブマシンガンの珍しい消音型で、PP-91-01 \"ケダール-B\" と呼ばれている。"
...
L["eft_weapon_blicky_full"] = "20x1mm トイガン"
L["eft_weapon_blicky_desc"] = "20x1mmの円盤を発射するプラスチック製セミオートトイガン。対象年齢5歳以上。ソ連製。"
