...
L["eft_axmc_magwell.description"] = "AXMC标准弹匣口径转换器。."

L["eft_axmc_railmid_b.printname"] = "AI AXMC Adapter Kit中导轨 (Black)" -- from "628120dd308cb521f87a8fa1 Name"
L["eft_axmc_railshort_b.printname"] = "AI AXMC Adapter Kit短导轨 (Black)" -- from "628120d309427b40ab14e76d Name"

-- [[ Glock 17 / 18C / 19X ]]
-- glocks
L["eft_rec_g19x_black.printname"] = "Glock 19X 9x19手枪套筒 (Black)" -- from "63075cc5962d0247b029dc2a Name"

-- [[ P90 + Five-seveN ]]
-- p90
L["eft_p90_mag_opaque.printname"] = "FN 50发P90弹匣 (Non-Translucent)" -- from "5cc70093e4a949033c734312 Name"
...
L["eft_extras_stock_ak_aktom4_forawp.printname"] = "AXMC RD \"AK转M4\" 缓冲管转接器" -- modified "628a6678ccaab13006640e49 Name"
