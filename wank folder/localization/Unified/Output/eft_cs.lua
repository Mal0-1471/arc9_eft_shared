...
L["eft_hud_none"] = "Nic"
L["eft_hud_malf"] = "Závada: \"{0}\"":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "Útočné karabiny"
L["eft_subcat_ar"] = "1" .. "Útočné pušky"
L["eft_subcat_sg"] = "6" .. "Brokovnice"
L["eft_subcat_snip"] = "4" .. "Odstřelovací pušky" .. " & " .. "Ostrostřelecké pušky"
L["eft_subcat_smg"] = "2" .. "Samopaly"
L["eft_subcat_lmg"] = "3" .. "Lehké kulomety"
L["eft_subcat_pist"] = "7" .. "Pistole"
L["eft_subcat_melee"] = "9" .. "Chladné zbraně"
L["eft_subcat_grenades"] = "8" .. "Granáty" .. " & " .. "Granátomety"
