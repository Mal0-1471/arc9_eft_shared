...
L["eft_hud_malf"] = "Malfunction: {0}":gsub("{0}", "%%s")
...
-- L["eft_subcat_snip"] = "4" .. "Mesterlövész puska" .. " & " .. "Marksman rifles"
-- L["eft_subcat_smg"] = "2" .. "Submachine guns"
-- L["eft_subcat_lmg"] = "3" .. "Könnyű géppuska"
-- L["eft_subcat_pist"] = "7" .. "Pistols"
-- L["eft_subcat_melee"] = "9" .. "Melee weapons"
-- L["eft_subcat_grenades"] = "8" .. "Grenades" .. " & " .. "Grenade launchers"
...
-- [[ Shared ]]
-- Optics
L["eft_optic_exps3.printname"] = "EOTech EXPS3 holographic sight" -- from "558022b54bdc2dac148b458d Name"
