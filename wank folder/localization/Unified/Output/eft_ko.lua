...
L["eft_hud_none"] = "없음"
L["eft_hud_malf"] = "기능고장: \"{0}\"":gsub("{0}", "%%s")
...
L["eft_subcat_snip"] = "4" .. "저격소총" .. " & " .. "Marksman rifles"
L["eft_subcat_smg"] = "2" .. "Submachine guns"
L["eft_subcat_lmg"] = "3" .. "경기관총"
L["eft_subcat_pist"] = "7" .. "Pistols"
L["eft_subcat_melee"] = "9" .. "Melee weapons"
L["eft_subcat_grenades"] = "8" .. "수류탄" .. " & " .. "Grenade launchers"
...
-- [[ Shared ]]
-- Optics
L["eft_optic_exps3.printname"] = "EOTech EXPS3 홀로그래픽 조준경" -- from "558022b54bdc2dac148b458d Name"
