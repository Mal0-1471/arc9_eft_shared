...
L["eft_hud_none"] = "Brak"
L["eft_hud_malf"] = "Zacięcie: {0}":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "Karabin. samopowtarzalne"
L["eft_subcat_ar"] = "1" .. "Karabin. automatyczne"
L["eft_subcat_sg"] = "6" .. "Strzelby"
L["eft_subcat_snip"] = "4" .. "Karabiny wyborowe" .. " & " .. "Karabiny wyborowe"
L["eft_subcat_smg"] = "2" .. "Pistolety maszynowe"
L["eft_subcat_lmg"] = "3" .. "Ręczne karabiny maszynowe"
L["eft_subcat_pist"] = "7" .. "Pistolety"
L["eft_subcat_melee"] = "9" .. "Broń biała"
L["eft_subcat_grenades"] = "8" .. "Granaty" .. " & " .. "Granatniki"
