...
L["eft_hud_none"] = "なし"
L["eft_hud_malf"] = "動作不良: \"{0}\"":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "アサルトカービン"
L["eft_subcat_ar"] = "1" .. "アサルトライフル"
L["eft_subcat_sg"] = "6" .. "ショットガン"
L["eft_subcat_snip"] = "4" .. "スナイパーライフル" .. " & " .. "マークスマンライフル"
L["eft_subcat_smg"] = "2" .. "サブマシンガン"
L["eft_subcat_lmg"] = "3" .. "軽機関銃"
L["eft_subcat_pist"] = "7" .. "ピストル"
L["eft_subcat_melee"] = "9" .. "近接武器"
L["eft_subcat_grenades"] = "8" .. "グレネード" .. " & " .. "グレネードランチャー"
