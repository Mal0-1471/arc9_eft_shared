...
L["eft_hud_malf"] = "Pane: {0}":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "Assault carbines"
L["eft_subcat_ar"] = "1" .. "Assault rifles"
L["eft_subcat_sg"] = "6" .. "Shotguns"
L["eft_subcat_snip"] = "4" .. "Rifle de Precisão" .. " & " .. "Marksman rifles"
L["eft_subcat_smg"] = "2" .. "Submachine guns"
L["eft_subcat_lmg"] = "3" .. "Metralhadora Leve"
L["eft_subcat_pist"] = "7" .. "Pistols"
L["eft_subcat_melee"] = "9" .. "Melee weapons"
L["eft_subcat_grenades"] = "8" .. "Granadas" .. " & " .. "Grenade launchers"
...
L["eft_akn.description"] = "Trilho para instalação de miras e outros dispositivos na AKM."
