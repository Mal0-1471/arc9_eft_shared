...
L["eft_hud_malf"] = "Malfunzionamento: \"{0}\"":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "Carabine d'assalto"
L["eft_subcat_ar"] = "1" .. "Fucili d'assalto"
L["eft_subcat_sg"] = "6" .. "Fucili a pompa"
L["eft_subcat_snip"] = "4" .. "Fucili di precisione" .. " & " .. "Fucili da tiratore scelto"
L["eft_subcat_smg"] = "2" .. "Mitragliatrici"
L["eft_subcat_lmg"] = "3" .. "Mitragliatrice Leggera"
L["eft_subcat_pist"] = "7" .. "Pistole"
L["eft_subcat_melee"] = "9" .. "Armi bianche"
L["eft_subcat_grenades"] = "8" .. "Granate" .. " & " .. "Lanciagranate"
...
-- [[ Shared ]]
-- Optics
L["eft_optic_exps3.printname"] = "Mirino olografico EOTech EXPS3" -- from "558022b54bdc2dac148b458d Name"
