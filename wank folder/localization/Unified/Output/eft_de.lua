...
L["eft_hud_none"] = "Aus"
L["eft_hud_malf"] = "Fehlfunktion: {0}":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "Sturmkarabiner"
L["eft_subcat_ar"] = "1" .. "Sturmgewehre"
L["eft_subcat_sg"] = "6" .. "Schrotflinten"
L["eft_subcat_snip"] = "4" .. "Scharfschützengewehre" .. " & " .. "Präzisionsgewehre"
L["eft_subcat_smg"] = "2" .. "Maschinenpistolen"
L["eft_subcat_lmg"] = "3" .. "Leichte Maschinengewehre"
L["eft_subcat_pist"] = "7" .. "Pistolen"
L["eft_subcat_melee"] = "9" .. "Nahkampfwaffen"
L["eft_subcat_grenades"] = "8" .. "Granaten" .. " & " .. "Granatenwerfer"
