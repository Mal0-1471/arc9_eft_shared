...
L["eft_hud_malf"] = "Mal funcionamiento: \"{0}\"":gsub("{0}", "%%s")
...
L["eft_subcat_carb"] = "5" .. "Carabinas de asalto"
L["eft_subcat_ar"] = "1" .. "Fusiles de asalto"
L["eft_subcat_sg"] = "6" .. "Escopetas"
L["eft_subcat_snip"] = "4" .. "Fusiles de francotirador" .. " & " .. "Fusiles de tirador designado"
L["eft_subcat_smg"] = "2" .. "Subfusiles"
L["eft_subcat_lmg"] = "3" .. "Ametralladoras Ligeras"
L["eft_subcat_pist"] = "7" .. "Pistolas"
L["eft_subcat_melee"] = "9" .. "Armas cuerpo a cuerpo"
L["eft_subcat_grenades"] = "8" .. "Granadas" .. " & " .. "Lanzagranadas"
